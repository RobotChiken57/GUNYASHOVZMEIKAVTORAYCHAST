...
Snake.prototype.draw = function(){        // цвет змеи//
...
Apple.prototype.move = function (occupiedBlocks){ //перемещение яблока //
...
var gameLoop = function(){ // третье задание ускорение  змейки при поедании яблок //
